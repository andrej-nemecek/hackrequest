...
export default async function VerificationSuccessPage({
    ...
    const filteredTickets = await db.select().from(tickets).where(
        ...
        <div className="container mx-auto p-4 flex items-center justify-center min-h-screen">
            <Card className="max-w-xl w-full">
                <CardHeader>
                    ...
                    <CardTitle className="text-center text-2xl">Verification Successful</CardTitle>
                ...
                <CardContent>
                    ...
                    <div className="flex mt-2">
                        <Link className="w-full" href="/support/todo">
